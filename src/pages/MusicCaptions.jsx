...
function MusicCaptions() {
  ...
  const payment = usePayment({
    ...
    onMpesaSuccess: (ref) => runProcessing(ref),
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-pink-900 text-white p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="bg-white/10 rounded-xl p-6">
              ...
              {videoUrl && (
                <video src={videoUrl} controls className="w-full mt-3 rounded-lg max-h-48 bg-black" />
              )}
            </div>
            ...
            <div className="bg-white/10 rounded-xl p-6">
              ...
              <PaymentOptions
                ...
                amountKes={MUSIC_CAPTIONS_PRICE}
          ...
          <div className="space-y-6">
            <div className="bg-white/10 rounded-xl p-6">
              ...
              <div className="flex gap-2 mb-4">
                ...
                />
                <button onClick={handleAddCaption} className="bg-pink-500 px-4 py-2 rounded-lg">
                  Add
                </button>
              </div>
              <div className="space-y-2 max-h-60 overflow-y-auto">
                {captions.map((c) => (
                  <div key={c.id} className="flex justify-between bg-white/5 rounded-lg p-3">
                    ...
                    <button
                      onClick={() => setCaptions(captions.filter((x) => x.id !== c.id))}
        ...
        {resultVideoUrl && (
          <div className="mt-8 bg-white/10 rounded-xl p-6">
            ...
            <a
              ...
              download
              className="inline-block bg-green-500 mt-4 px-6 py-2 rounded-lg"
            >
              ⬇️ Download
            </a>
          </div>
        ...
        {success && (
          <div className="mt-4 bg-green-500/20 border border-green-500 rounded-lg p-3 text-green-300 text-sm text-center">
            {success}
          </div>
        )}
      </div>
