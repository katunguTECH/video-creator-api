...
const TOOL_PAGES = [
  {
    ...
    faqs: [
      ...
      { q: 'How much does it cost?', a: 'A flat KES 300 per video, regardless of length up to 50 MB. No subscription.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much does it cost?', a: 'A flat KES 300 per video, regardless of length up to 50 MB.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much does it cost?', a: 'From KES 300 for a single photo in a 5-second clip. Multi-photo videos scale proportionally.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How long is the video?', a: 'Typically 5, 10, or 15 seconds depending on the number of photos and your chosen duration.' },
      { q: 'How much does it cost?', a: 'From KES 300 per video. Pricing scales with number of photos and duration.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much does it cost?', a: 'A flat KES 250 per video. No subscription, no hidden fees.' },
